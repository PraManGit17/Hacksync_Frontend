        ...
        <div className="space-y-3 mb-8">
          {topic.resources.map(r => (
            <a
              ...
              href={r.url}
              target="_blank"
              className="flex items-center justify-between px-5 py-3 bg-zinc-900/60 border border-zinc-800 rounded-xl text-sm hover:border-purple-500/50 transition-all"
            >
              <span>{r.label}</span>
